...
export class FargateStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: FargateStackProps) {
    ...
    const { vpc, auroraCluster, auroraSecurityGroup } = props;
    ...
    // Fargateタスクロールに対してAurora secretの読み取り権限を付与
    auroraCluster.secret!.grantRead(this.service.taskDefinition.taskRole);
